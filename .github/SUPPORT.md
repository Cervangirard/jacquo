# Getting help with jacquo

Thanks for using jacquo. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/jacquo/issues) to make sure the 
